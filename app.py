...
# Sample data: List of transcripts corresponding to video IDs
transcripts_data = [
    {"video_id": "VIDEO_ID_1", "transcript": "This is the transcript for video 1."},
    {"video_id": "VIDEO_ID_2", "transcript": "This is the transcript for video 2."},
    # Add more video_id and transcript pairs as needed
]
